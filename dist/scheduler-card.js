...
/**
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${ts(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${Ls}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${Bi("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[d,r.length])}</span>
        </ha-list-item>
        ${this.expandedGroups.includes(o)||t?Z`
        <div class="group ${t?"open":""}">
          <li role="divider"></li>
        ${r.map(e=>{var t,i;return Z`
          <ha-list-item
            graphic="icon"
            twoline
            hasMeta
            ...
            key="${e.key}"
          >
            ${Object.keys(this.hass.states).includes(e.key)?Z`<ha-state-icon .stateObj=${this.hass.states[e.key]} .hass=${this.hass} slot="graphic"></ha-state-icon>`:Z`<ha-icon slot="graphic" icon="${e.icon}"></ha-icon>`}
            <ha-checkbox
              slot="meta"
    ...
    `}};a([Ws({attribute:!1})],oa.prototype,"hass",void 0),a([Bs()],oa.prototype,"_params",void 0),a([Bs()],oa.prototype,"_search",void 0),a([Bs()],oa.prototype,"_filter",void 0),a([Bs()],oa.prototype,"_width",void 0),a([Bs()],oa.prototype,"_height",void 0),a([Bs()],oa.prototype,"expandedGroups",void 0),a([Bs()],oa.prototype,"options",void 0),a([Bs()],oa.prototype,"scheduleEntities",void 0),oa=a([Hs("dialog-select-entities")],oa);var na=Object.freeze({__proto__:null,get DialogSelectEntities(){return oa}});let ra=class extends he{constructor(){super(...arguments),this.active=!1}render(){return Z`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return G;if(this.toggleable)return Z`
        <div class="icon">
          <ha-icon
            icon="mdi:check"
          ></ha-icon>
        </div>
      `;if(this.useStateIcon){let e=this.hass.states[this.value||""];return Z`
          <div class="icon filled">
            ${e?Z`<ha-state-icon .stateObj=${e} .hass=${this.hass}></ha-state-icon>`:Z`<ha-icon icon="mdi:help-circle-outline"></ha-icon>
            `}
          </div>
        `}return Z`
        <div class="icon filled">
      ...
      `}renderTrailingIcon(){const e=`icn_${Math.random().toString(36).substring(2,9)}`;return this.removable||this.badge?this.badge?Z`
        <div class="badge">
          ${this.badge}
        </div>
      `:Z`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?G:Z`<ha-tooltip for="${e}">${ts("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
      `:G}_handleClick(e){if(!this.disabled){if(this.toggleable){this.active=!this.active;const e=new CustomEvent("click",{detail:{active:this.active,value:this.value}});this.dispatchEvent(e)}else{const e=new CustomEvent("click",{detail:{value:this.value}});this.dispatchEvent(e)}e.stopPropagation()}}_iconClick(e){if(e.stopPropagation(),this.disabled)return;const t=new CustomEvent("icon-clicked",{detail:{value:this.value}});this.dispatchEvent(t)}static get styles(){return c`
      :host {
        margin: 4px;
      }
      .chip {
    ...
    `}};a([Ws({attribute:!1})],ra.prototype,"hass",void 0),a([Ws({type:String})],ra.prototype,"icon",void 0),a([Ws({type:Boolean})],ra.prototype,"useStateIcon",void 0),a([Ws({type:Boolean})],ra.prototype,"selectable",void 0),a([Ws({type:Boolean})],ra.prototype,"removable",void 0),a([Ws({type:Boolean})],ra.prototype,"toggleable",void 0),a([Ws({type:Boolean})],ra.prototype,"active",void 0),a([Ws({type:String})],ra.prototype,"badge",void 0),a([Ws({type:String})],ra.prototype,"value",void 0),a([Ws({type:Boolean})],ra.prototype,"disabled",void 0),ra=a([Hs("scheduler-chip")],ra);let da=class extends he{constructor(){super(...arguments),this.value=[]}render(){return this.items?Z`
      ${Object.values(this.items).map(e=>this.renderChipitem(e))}
    `:Z``}renderChipitem(e){const t=e.useStateIcon&&!Object.keys(this.hass.states).includes(e.value||"");return Z`
      <scheduler-chip
        .hass=${this.hass}
    ...
    `}};a([Ws({attribute:!1})],da.prototype,"hass",void 0),a([Ws({attribute:!1})],da.prototype,"items",void 0),a([Ws({attribute:!1})],da.prototype,"value",void 0),a([Ws({type:Boolean})],da.prototype,"selectable",void 0),a([Ws({type:Boolean})],da.prototype,"toggleable",void 0),a([Ws({type:Boolean})],da.prototype,"removable",void 0),a([Ws({type:Boolean})],da.prototype,"disabled",void 0),da=a([Hs("scheduler-chip-set")],da);const la=[{name:"primary",weight:10},{name:"secondary",weight:8}];let ca=class extends he{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return Z`
        <ha-svg-icon
          slot="start"
          .path=${Vs}
          style="margin: 0 4px"
      ...
      `;const s=this._parseEntityItem(t);return Z`
      ${s.icon?Z`
        <ha-icon
          slot="start"
          icon="${s.icon}"
    ...
    `},this._rowRenderer=e=>{const t=e.id||"",i=this.hass.states[t];return Z`
      <ha-combo-box-item type="button" compact>
        ...
        ${e.secondary?Z`<span slot="supporting-text">${e.secondary}</span>`:G}
      </ha-combo-box-item>
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);this.domain&&(e=e.filter(e=>Ki(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||Ue).some(t=>Ji(t,e))||Object.keys(this.config.customize||{}).some(t=>Ji(t,e)))&&!(this.config.exclude||[]).some(t=>Ji(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e])));let t=e.map(e=>this._parseEntityItem(e));return t}}async firstUpdated(){this.scheduleEntities=Object.entries(await Se(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!Yi(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],Ds(this,"value-changed",{value:this.value}))}render(){var e,t;return Z`
      ${this.renderChips()}

      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?G:Z`

      <ha-generic-picker
        .label=${(null===(t=this.value)||void 0===t?void 0:t.length)?"":ts("ui.components.entity.entity-picker.choose_entity",this.hass)}
        .hass=${this.hass}
        .autofocus=${this.autofocus}
        .notFoundLabel=${ts("ui.components.combo-box.no_match",this.hass)}
        ...
        .searchKeys=${la}
        .searchLabel=${ts("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
      ...
      `}
    `}renderChips(){if(!this.multiple)return G;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return Z`
      <div class="wrapper">
      <scheduler-chip-set
        .hass=${this.hass}
        .items=${e}
      ...
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),Ds(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),Ds(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Ji(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Gi(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};ca.styles=c`
    :host {
      display: flex;
  ...
  `,a([t.property({attribute:!1})],ca.prototype,"hass",void 0),a([t.property()],ca.prototype,"domain",void 0),a([t.property()],ca.prototype,"config",void 0),a([t.property({type:Array})],ca.prototype,"value",void 0),a([t.property({type:Boolean})],ca.prototype,"multiple",void 0),a([t.property({type:Boolean})],ca.prototype,"disabled",void 0),a([t.state()],ca.prototype,"multipleMode",void 0),a([t.state()],ca.prototype,"scheduleEntities",void 0),ca=a([t.customElement("scheduler-entity-picker")],ca);let ha=class extends he{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return Z`
      <div
    ...
    `}};a([t.property({type:Boolean,reflect:!0})],ha.prototype,"expanded",void 0),a([t.property({type:Boolean,reflect:!0})],ha.prototype,"disabled",void 0),a([t.property({attribute:!0})],ha.prototype,"idx",void 0),a([t.property({type:CustomEvent})],ha.prototype,"openClose",void 0),ha=a([t.customElement("scheduler-collapsible-section")],ha);let ua=class extends he{set openedItem(e){e!==this._openedItem&&void 0!==e&&setTimeout(()=>{this.updateOpenedItem(e)},50)}constructor(){super(),this.disabled=!1,this._openedItem=-1,this._numItems=0,this.addEventListener("open-close",this.toggleActiveSection)}firstUpdated(){const e=this.querySelectorAll("scheduler-collapsible-section");this._numItems=e.length}toggleActiveSection(e){if(this.disabled)return;const t=e.target,i=Number(t.getAttribute("idx"));"true"===t.getAttribute("expanded")?this.updateOpenedItem(-1):this.updateOpenedItem(i)}updateOpenedItem(e){this.querySelectorAll("scheduler-collapsible-section").forEach(function(t){const i=Number(t.getAttribute("idx"));i!==e&&t.getAttribute("expanded")?t.removeAttribute("expanded"):i!==e||t.getAttribute("expanded")||t.setAttribute("expanded","true")}),this._openedItem=e;const t=new CustomEvent("openclose-changed",{detail:{item:e}});this.dispatchEvent(t)}render(){return Z`
      <slot></slot>
    `}};a([t.property()],ua.prototype,"disabled",void 0),a([t.state()],ua.prototype,"_openedItem",void 0),a([t.state()],ua.prototype,"_numItems",void 0),ua=a([t.customElement("scheduler-collapsible-group")],ua);const ma="__NONE_OPTION__";let pa=class extends he{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Ds(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return Z`
        <scheduler-chip-set
          .hass=${this.hass}
          .items=${e}
          removable
          @value-changed=${i}
        >
        </scheduler-chip-set>`},a=e=>{var t;let i=null===(t=this.config.select)||void 0===t?void 0:t.translation_key,s="";return i&&(s=ts(i.replace("${value}",e),this.hass,!1)),s||(s=e),s},o=e=>"object"==typeof e?{id:e.value,primary:a(e.label),icon:e.icon}:{id:e,primary:a(e)};let n=[...null==e?void 0:e.options].map(o),r=[this.value||[]].flat().map(String);n=[...n,...r.filter(e=>!n.find(t=>t.id==e)).map(o)],Array.isArray(this.value)&&(n=n.filter(e=>"object"==typeof e?!t.includes(e.id):!t.includes(e)));const d=()=>n.length?(n.some(e=>e.icon),n.map(e=>Z`
          <ha-dropdown-item
            .value=${e.id}
          >
            ${e.icon?Z`<ha-icon slot="icon" .icon=${e.icon}></ha-icon>`:G}
            <span>${e.primary}</span>
          </ha-dropdown-item>
        `)):Z`
          <ha-dropdown-item .value=${ma}>
            ${this.hass.localize("ui.components.combo-box.no_match")}
          </ha-dropdown-item>
        `,l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",`${i.offsetWidth}px`),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=ma&&!Array.isArray(this.value)||(e.target.value=void 0,t!=ma))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},m=Ze(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,p=m?m.primary||m.id:Ze(this.value)&&!Array.isArray(this.value)?this.value:void 0;return Z`
        <div class="select-wrapper">
          ...
          >
            <ha-picker-field
              ...
              @clear=${u}
              .disabled=${this.disabled}
              .hideClearIcon=${this.disabled||!Ze(this.value)||Array.isArray(this.value)&&!this.value.length}
              .value=${p}
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ze(t.min)||!Ze(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ze(s)&&(s=ls(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=ls(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ze(t.min)&&(s=Number(e)>=t.min),s&&Ze(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return Z`
      ...
      `}if(this.config.text)return this.config.text,Z`
      ...
      `;if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=Ze(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return Z`
      ...
      `}return Z``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Ds(this,"value-changed",{value:this.value})}};pa.styles=c`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,a([t.property({attribute:!1})],pa.prototype,"hass",void 0),a([t.property({attribute:!1})],pa.prototype,"config",void 0),a([t.property()],pa.prototype,"value",void 0),a([t.property({type:Boolean})],pa.prototype,"disabled",void 0),pa=a([t.customElement("scheduler-combo-selector")],pa);let _a=class extends he{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[],this.customTagValue=""}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Ps(this.hass)).map(e=>e.name);e.sort(Xi),this.tagOptions=e}render(){var e,t,i,s,a,o;const n={number:{min:0,max:30,step:1,unit_of_measurement:Bi("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},r={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return Z`
          ...
          <div class="column">
            <ha-formfield label="${Bi("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${pe.Single}"
                @change=${()=>{this._updateConfig({default_editor:pe.Single})}}
                ?checked=${this._config.default_editor!=pe.Scheme}
              >
              </ha-radio>
            </ha-formfield>
          </div>
          <div class="column">
            <ha-formfield label="${Bi("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${pe.Scheme}"
                @change=${()=>{this._updateConfig({default_editor:pe.Scheme})}}
                ?checked=${this._config.default_editor==pe.Scheme}
              >
              </ha-radio>
            </ha-formfield>
        ...
        <div class="column">
          ...
          <ha-formfield label="${Bi("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              ...
              ?checked=${[this._config.sort_by||Re].flat().includes("relative-time")}
            ></ha-radio>
          </ha-formfield>
        ...
        <div class="column">
          ...
          <ha-formfield label="${Bi("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              ...
              value="title"
              @change=${this._setSortBy}
              ?checked=${[this._config.sort_by||Re].flat().includes("title")}
            ></ha-radio>
          </ha-formfield>
        </div>
        </div>
        ...
        <div class="column">
          ...
          <ha-formfield label="${Bi("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
              ...
              ?checked=${[(null===(e=this._config.display_options)||void 0===e?void 0:e.primary_info)||Ve].flat().includes("default")}
            >
            </ha-radio>
          </ha-formfield>
        ...
        <div class="column">
          ...
          <ha-formfield label="${Bi("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              ...
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
              ?checked=${[(null===(t=this._config.display_options)||void 0===t?void 0:t.primary_info)||Ve].flat().includes("{entity}: {action}")}
            >
            </ha-radio>
          </ha-formfield>
  ...
  `,a([t.property({attribute:!1})],_a.prototype,"hass",void 0),a([t.property()],_a.prototype,"_config",void 0),a([t.property()],_a.prototype,"title",void 0),a([t.property()],_a.prototype,"tagOptions",void 0),a([t.state()],_a.prototype,"customTagValue",void 0),_a=a([t.customElement("scheduler-card-editor")],_a);const ga=c`
  ha-dialog {
...
`;const va=(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=ds(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===ms(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Ki(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))};var ya;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ya||(ya={}));const fa=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>{const i=e.every((i,s)=>{const a=Ee(i.start,t),o=void 0===i.stop?a:Ee(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>i<=s||Ee(e.start,t)>=o)});return i?null:ya.OverlappingTime})(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,ya.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=ds(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?ya.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>va(e,s,t,i)).every(([s,a])=>{var o,n;let r=ms(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d||!Ze(e.service_data[s])&&!d)})?ya.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},ba=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))});let i={weekdays:e.entries[0].weekdays.map(wa),timeslots:e.entries[0].slots.map(ka),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},wa=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},ka=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>xa(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),xa=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ze(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){let t=null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}));return t}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},$a=(e,t,i)=>{const s={title:ts("state_badge.default.error",i),description:Z`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:ts("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Ds(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:s})},ja=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Oa=(e,t)=>{const i=ds(e,t),s=Ki(e.service),a=Zi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:`mdi:${o}`;if(Object.keys(us).includes(s)&&Object.keys(us[s].services).includes(a)){if(void 0!==us[s].attributes){let t=us[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return us[s].services[a]}return Object.keys(us).includes(s)&&Object.keys(us[s].services).includes("{entity_id}")?us[s].services["{entity_id}"]:"mdi:flash";var o},Sa=(e,t,i)=>{let s=Ee("string"==typeof e?Ae(e):e,i),a=Ee("string"==typeof t?Ae(t):t,i);return a>s?1:a<s?-1:0},za=e=>Ae(e.start),Ca=e=>{if(Ze(e.stop)){const t=Ae(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return ze(za(e),{minutes:1})},Aa=(e,t,i,s)=>{let a=t;if(Ze(i.stop))return[e,a]=Aa(e,t+1,{start:i.stop},s),[e,a-1];if(!Ze(i.start))return[e,a];let o=za(e[t]),n=i.start,r=za(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?ze(za(e[i]),{minutes:1}):Ca(e[i]);break}r=za(e[i])}let d=ze(Ca(e[t]),{minutes:-1});if(!Ze(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?ze(Ca(e[i]),{minutes:-1}):za(e[i]);break}d=Ca(e[i])}if(Sa(r,n,s)<0&&(n=r),Sa(d,n,s)>0&&Ee(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ie(n)})}),Sa(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Sa(za(e[i]),n,s),o=Sa(Ca(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ie(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Sa(o,n,s)<0&&!Ze(e[t].stop)&&(e=Ze(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ie(Ca(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ie(Ca(e[t])),stop:Ie(za(e[t+1])),actions:[]}),...e.slice(t+1)]),Sa(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Ca(e[a]),o=Sa(za(e[t]),i,s),n=Sa(Ca(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ie(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Sa(o,n,s)>0&&(t>0&&Ze(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ie(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Ie(Ca(e[t-1])):"00:00:00",stop:Ie(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Ze),a]},Ea=1;let Ta=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
     * @license
     * Copyright 2018 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const Da="important",Ma=" !"+Da,Pa=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Ta{constructor(e){if(super(e),e.type!==Ea||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(t)),this.render(t);for(const e of this.ft)null==t[e]&&(this.ft.delete(e),e.includes("-")?i.removeProperty(e):i[e]=null);for(const e in t){const s=t[e];if(null!=s){this.ft.add(e);const t="string"==typeof s&&s.endsWith(Ma);e.includes("-")||t?i.setProperty(e,t?s.slice(0,-11):s,t?Da:""):i[e]=s}}return K}}),La=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ce({hours:n,minutes:r})},Na=86400;let Ia=class extends he{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this.large=!1}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e)}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}render(){return Z`
      <div class="bar">
    ...
    `}renderTimebar(){const e=this._width,t=[1,2,3,4,6,8,12],i=Me(this.hass.locale),s=i?130:100;if(!e)return Z``;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?Z`
        <span class="left" style=${Pa({width:s/2+"%"})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?Z`
        <span class="right" style=${Pa({width:s/2+"%"})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `:Z`
        <span style=${Pa({width:`${s}%`})}>${Ie(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?ws(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1];return Z`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Pa({width:`${t[s]}px`})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?Z`<span style="margin-left: ${n}px; margin-right: ${r}px">${a}</span>`:d>16?Z`<ha-icon icon="${Oa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ${s<e.length-1&&i.stop?Z`
        ...
        `:""}
      `})}computeSlotWidths(){const e=this._width,t=this.schedule.slots,i=e-3*(t.length-1),s=t.map((e,i)=>{const s=Ee(e.start,this.hass);let a;if(void 0!==e.stop)a=Ee(e.stop,this.hass),!a&&s&&(a=Na);else{const e=t[i+1];a=e&&Ee(e.start,this.hass)||Na}return(a-s)/Na}),a=5/i,o=s.filter(e=>e<a).length,n=i-5*o,r=s.map(e=>e<a?5:e*n);return r}_toggleSelectTimeslot(e){let t=e.target;"div"!=t.tagName.toLowerCase()&&(t=t.parentElement);const i=Number(t.getAttribute("idx"));this.selectedSlot=this.selectedSlot!==i?i:null;const s=new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}});this.dispatchEvent(s),e.stopPropagation()}_handleDragStart(e){e.preventDefault(),e.stopPropagation();let t=e.target;for(;"DIV"!==t.tagName;)t=t.parentElement;const i=t.parentElement.getBoundingClientRect(),s=Number(t.getAttribute("idx")),a=this.config.time_step||15,o=60*a;let n=s>0?Ee(this.schedule.slots[s-1].stop||this.schedule.slots[s-1].start,this.hass)+o:o,r=(Ee(this.schedule.slots[s+1].stop||this.schedule.slots[s+1].start,this.hass)||Na)-o;void 0===this.schedule.slots[s+1].stop&&(r=(Ee(this.schedule.slots[s+2].stop||this.schedule.slots[s+2].start,this.hass)||Na)-o);const d=Ae(this.schedule.slots[s+1].start).mode;if([we.Sunrise,we.Sunset].includes(d)){let e=Ae(this.schedule.slots[s+1].start),t=Ee(Object.assign(Object.assign({},e),{hours:4,minutes:0}),this.hass),i=Ee(Object.assign(Object.assign({},e),{hours:-4,minutes:0}),this.hass);i>n&&(n=i),t<r&&(r=t)}let l=e=>{let t;e.preventDefault(),t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX,t-=i.left,t>i.width&&(t=i.width),t<0&&(t=0);let o=Math.round(t/i.width*Na);o<n?o=n:o>r&&(o=r);const l=Math.floor(o/3600),c=Math.round((o-3600*l)/60);let h={mode:we.Fixed,hours:l,minutes:c};if([we.Sunrise,we.Sunset].includes(d)){const e=d==we.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,t=La(h,e);h={mode:d,hours:t.hours,minutes:t.minutes}}h=Ce(h,a);const u=Ie(h);let m=[...this.schedule.slots];if(m=Object.assign(m,{[s]:Object.assign(Object.assign({},m[s]),{stop:u}),[s+1]:Object.assign(Object.assign({},m[s+1]),{start:Ie(h)})}),void 0===m[s+1].stop){const e=Ie(ze(h,{minutes:1}));m=Object.assign(m,{[s+2]:Object.assign(Object.assign({},m[s+2]),{start:e})})}this.schedule=Object.assign(Object.assign({},this.schedule),{slots:m});const p=new CustomEvent("update",{detail:{slots:m}});this.dispatchEvent(p)};const c=e=>{e.preventDefault()},h=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("touchmove",l),window.removeEventListener("mouseup",h),window.removeEventListener("touchend",h),window.removeEventListener("blur",h),window.removeEventListener("dragstart",c),l=()=>{}};window.addEventListener("mouseup",h),window.addEventListener("touchend",h),window.addEventListener("blur",h),window.addEventListener("dragstart",c),window.addEventListener("mousemove",l),window.addEventListener("touchmove",l)}static get styles(){return c`
      :host {
        display: block;
        max-width: 100%;
        overflow: hidden;
    ...
    `}};a([Ws({attribute:!1})],Ia.prototype,"config",void 0),a([Bs()],Ia.prototype,"schedule",void 0),a([Bs()],Ia.prototype,"selectedSlot",void 0),a([Bs()],Ia.prototype,"_width",void 0),a([Ws({type:Boolean})],Ia.prototype,"large",void 0),Ia=a([Hs("scheduler-timeslot-editor")],Ia);const qa=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Ra=class extends he{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ae(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return Z`
      <div class="time-input-wrap">
        <div class="input">
          ${this.label?Z`<span class="label">${this.label}</span>`:G}
          ${this.large?G:this._renderTimeMode()}
          <div class="hours">
            ${this.large?Z`
            <ha-button
              appearance="plain"
          ...
          ${this.large?Z`<div class="separator">:</div>`:G}
          <div class="minutes">
            ${this.large?Z`
            <ha-button
              appearance="plain"
          ...
          ${this._renderSuffix()}
          ${this.large?this._renderTimeMode():G}
        </div>
      </div>
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return G;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=qa(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return Z`
        <div class="mode">
          ${this.hass.states["sun.sun"]?Z`
          <ha-button
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Le(this.hours).am_pm;const t=Le(this.hours).hours;this.hours=Ne(t,"AM"==e?Pe.PM:Pe.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return Z`
      ...
      `}return this.useAmPm&&this.mode==we.Fixed?Z`
        <ha-select
          .required=${this.required}
      ...
      `:G}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=La({hours:this.hours,minutes:this.minutes},t),a=La({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),d=r==we.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==we.Sunrise?Ae(t):Ae(i);return e=ze(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Le(this.hours).am_pm;t=Ne(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Le(this.hours).am_pm==t)return;const i=Le(this.hours).hours;this.hours=Ne(i,"AM"==t?Pe.AM:Pe.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=ze(t,e),e.minutes&&(t=Ce(t,this.stepSize)),this.mode!=we.Fixed&&(t=qa(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Ds(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Le(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};Ra.styles=c`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,a([t.property({attribute:!1})],Ra.prototype,"hass",void 0),a([t.state()],Ra.prototype,"hours",void 0),a([t.state()],Ra.prototype,"minutes",void 0),a([t.state()],Ra.prototype,"mode",void 0),a([t.property({type:Boolean})],Ra.prototype,"autoValidate",void 0),a([t.property({type:Boolean})],Ra.prototype,"required",void 0),a([t.property({type:Boolean})],Ra.prototype,"disabled",void 0),a([t.property({type:String})],Ra.prototype,"label",void 0),a([t.property({type:Boolean})],Ra.prototype,"useAmPm",void 0),a([t.property({type:Boolean})],Ra.prototype,"large",void 0),a([t.property({attribute:!1})],Ra.prototype,"stepSize",void 0),Ra=a([t.customElement("scheduler-time-picker")],Ra);const Va="Custom";let Ha=class extends he{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?Z`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
      >
        <ha-dialog-header slot="header">
          ${this.weekdayTypeCustomSelected?Z`
          <ha-icon-button
            slot="navigationIcon"
            .label=${ts("ui.dialogs.more_info_control.dismiss",this.hass)}
            .path=${Ns}
    ...
    `:Z``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday];const t=(e,t)=>e.concat(e).slice(t,t+e.length);e=t(e,js(this.hass))}else e=[_e.Daily,_e.Workday,_e.Weekend,Va];const t=e=>{var t,i;return e==Va?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>Z`
        <ha-list-item
          graphic="icon"
    ...
    `}};a([Ws({attribute:!1})],Ha.prototype,"hass",void 0),a([Bs()],Ha.prototype,"_params",void 0),a([Bs()],Ha.prototype,"weekdayTypeCustomSelected",void 0),a([Bs()],Ha.prototype,"selectedWeekdays",void 0),Ha=a([Hs("dialog-select-weekdays")],Ha);var Ua=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return Ha}});const Fa=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),Wa=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(ss).includes(t))return!1;let s=Object.keys(ss[t]).includes(e);if(!s&&Object.keys(ss[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=Yi(`${t}.${e}`,i)}return s}):[],a=t=>ts(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{const o=ts(`component.${t}.services.${s}.name`,e,!1)||!!e.services[t]&&!!e.services[t][s]&&e.services[t][s].name||s.replace(/_/g," ");return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Ze(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:o:`${a(t)}: ${o}`},n=i=>{let s=ts(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=ts(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Ze(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(us).includes(t)&&Object.keys(us[t].services).includes(a)?us[t].services[a]:Ks(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Ji(Ki(e),c)||Ji(e,c)).map(e=>l[e].exclude_actions).flat().filter(Ze));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>Fa(Zi(t.action.service),s)>0||Fa(ws(t.action,e,i.customize),s)>0))),rs(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=gs(i),a=ja(s);!Ze(e.service_data[t])&&Ze(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):Ze(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${Ba(e.name||o(Zi(e.service)))}`,description:Ba(e.name||""),icon:e.icon||Ks(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Ba=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Za=class extends he{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?Z`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ${void 0===this._params.domainFilter||this.lockDomain?Z`
            <ha-icon-button
              slot="navigationIcon"
               data-dialog="close"
              .label=${ts("ui.dialogs.more_info_control.dismiss",this.hass)}
            ...
            ${!this.lockDomain&&Ze(this._params.cardConfig.include)?Z`
            <ha-dropdown
              placement="bottom-end"
              slot="actionItems"
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .label=${this.hass.localize("ui.common.menu")} .path=${qs}>
              </ha-icon-button>
    ...
    `}};a([Ws({attribute:!1})],Za.prototype,"hass",void 0),a([Bs()],Za.prototype,"_params",void 0),a([Bs()],Za.prototype,"_search",void 0),a([Bs()],Za.prototype,"_filter",void 0),a([Bs()],Za.prototype,"_width",void 0),a([Bs()],Za.prototype,"_height",void 0),a([Bs()],Za.prototype,"lockDomain",void 0),a([Bs()],Za.prototype,"showAll",void 0),Za=a([Hs("dialog-select-action")],Za);var Ka=Object.freeze({__proto__:null,get DialogSelectAction(){return Za}});let Ga=class extends he{constructor(){super(...arguments),this.showPrefix=!1}render(){return Z`
      ${this.showPrefix?Z`
    ...
    `}};a([t.property({type:Boolean})],Ga.prototype,"showPrefix",void 0),Ga=a([t.customElement("scheduler-settings-row")],Ga);let Ja=class extends he{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return Z`
    ${this.schedule.entries.map((e,t)=>Z`
      ...
      <div class="editor-header">
        <div class="weekdays">
          ...
          <ha-icon-button .path=${Rs} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
        <div class="weekdays-actions">
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==pe.Scheme?Bi("ui.panel.editor.toggle_single_mode",this.hass):Bi("ui.panel.editor.toggle_scheme_mode",this.hass)}
          <ha-icon slot="end" icon="mdi:swap-horizontal"></ha-icon>
        </ha-button>
        </div>
      </div>

      ${this.viewMode==pe.Scheme?Z`
      <div class="editor-header">
        <div class="weekdays">
    ...
    ${this.renderSlot()}
    `}toggleViewMode(){const e=this.viewMode==pe.Scheme?pe.Single:pe.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return Z``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ee(e,this.hass),s=(Ee(t,this.hass)||86400)-i;return Z`
      <div class="actions">
        <ha-icon-button .path=${Ns} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `}_renderActionConfig(){var e,t,i,s;const a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),o=a.actions.length?a.actions[0]:void 0;if(!o)return Z`
      <div>
    ...
    `;const n=ds(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Ki(o.service),d=Ze(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ze(null===(i=null===(t=ds(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return Z``;const l=Object.keys(n.fields||{}).filter(e=>va(o,e,this.hass,this.config.customize));let c="",h=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!h.length&&["notify","script"].includes(r)&&(h=[o.service]),h.length&&(c+=h.map(e=>zs(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=ws(o,this.hass,this.config.customize,!1,!0),Z`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${Oa(o,this.config.customize)}"></ha-icon>
          <span>${es(c)}</span>
        </div>
        ...
        <ha-dropdown
          ...
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${qs}>
          </ha-icon-button>
        ...
        <div slot="content">
          ...
          ${l.map(e=>{var t;const i=ms(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return Z`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Ki(e.service),n=Zi(e.service);let r=ts(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat();let l=rs(s||{},d.length?d[0]:o);if(l.length){let i=l.map(i=>i.service==e.service&&Object.keys(i.variables||{}).includes(t)?(i.variables||{})[t].name:null).filter(Ze);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `:Z``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_renderOptions(){var e;let t=Object.assign({},null===(e=this._params)||void 0===e?void 0:e.cardConfig);this.showAll&&(t=Object.assign(Object.assign({},t),{include:void 0,exclude:void 0}));let i=ta(this.hass,t);return i.sort((e,t)=>Xi(e.name,t.name)),this._filter&&(i=i.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))})),Object.keys(i).map(e=>Z`
        <ha-list-item
          graphic="icon"
    ...
    `)}_handleDomainClick(e){this._params=Object.assign(Object.assign({},this._params),{domain:e}),this._params.confirm(e),this._params=void 0,this._clearSearch()}_toggleShowAll(){this.showAll?this.showAll=!1:this.showAll=!0}static get styles(){return c`
      ha-dialog {
        --dialog-content-padding: 0;
        --ha-dialog-width-md: 480px;
      }
    ...
    `}};a([Ws({attribute:!1})],io.prototype,"hass",void 0),a([Bs()],io.prototype,"_params",void 0),a([Bs()],io.prototype,"_search",void 0),a([Bs()],io.prototype,"_filter",void 0),a([Bs()],io.prototype,"_width",void 0),a([Bs()],io.prototype,"_height",void 0),a([Bs()],io.prototype,"showAll",void 0),io=a([Hs("dialog-select-condition")],io);var so=Object.freeze({__proto__:null,get DialogSelectCondition(){return io}});let ao=class extends he{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Qa(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Qa(new Date);const i=(await Ps(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return Z`
      <div class="header first">
        <span>${Bi("ui.panel.options.conditions.header",this.hass)}:</span>
        ${this.schedule.entries[0].slots[0].conditions.items.length?Z`
        <ha-dropdown
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Ki(s),o=ea(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ve.Above,ve.Below]:[ve.Equal,ve.Unequal],r={[ve.Equal]:"mdi:equal",[ve.Unequal]:"mdi:not-equal-variant",[ve.Above]:"mdi:greater-than",[ve.Below]:"mdi:less-than"},d={[ve.Equal]:"ui.panel.options.conditions.types.equal_to",[ve.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ve.Above]:"ui.panel.options.conditions.types.above",[ve.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),Z`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${es(Bi(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
              @wa-select=${this._selectMatchType}
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .path=${Rs}>
              </ha-icon-button>
              ${n.map(i=>Z`
                <ha-dropdown-item 
                ...
                >
                  ...
                  ${es(Bi(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
    ...
    `}};a([Ws({attribute:!1})],ao.prototype,"hass",void 0),a([Ws({attribute:!1})],ao.prototype,"config",void 0),a([Bs()],ao.prototype,"schedule",void 0),a([Bs()],ao.prototype,"conditionIdx",void 0),a([Bs()],ao.prototype,"selectedDomain",void 0),a([Bs()],ao.prototype,"selectedEntity",void 0),a([Bs()],ao.prototype,"selectedMatchType",void 0),a([Bs()],ao.prototype,"conditionValue",void 0),a([Bs()],ao.prototype,"conditionValid",void 0),a([Bs()],ao.prototype,"startDate",void 0),a([Bs()],ao.prototype,"endDate",void 0),a([Ws()],ao.prototype,"tags",void 0),a([Bs()],ao.prototype,"customTagValue",void 0),ao=a([Hs("scheduler-options-panel")],ao);let oo=class extends he{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?Z`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
      >
        ...
        <ha-dialog-footer slot="footer">
          ${this._params.secondaryButtonLabel?Z`
            <ha-button
              appearance="plain"
              slot="secondaryAction"
              @click=${this.cancelClick}
    ...
    `:Z``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=fa(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:ts("state_badge.default.error",this.hass),description:Bi(`ui.panel.editor.validation_errors.${t}`,this.hass),primaryButtonLabel:ts("ui.common.ok",this.hass)};Ds(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:s})});else if(this.schedule.schedule_id){const t=qe(await Ts(this.hass,this.schedule.schedule_id),this.hass);if(me(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Bi("ui.dialog.enable_schedule.title",this.hass),description:Bi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ts("ui.common.yes",this.hass),secondaryButtonLabel:ts("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ds(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=ba(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>$a(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=ba(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>$a(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Bi("ui.dialog.confirm_delete.title",this.hass),description:Bi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ts("ui.common.ok",this.hass),secondaryButtonLabel:ts("ui.common.cancel",this.hass)};Ds(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>$a(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t==pe.Scheme){this.viewMode=t;if(me([...this.schedule.entries],[...Be.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...We.entries]});else{const e=this.schedule.entries.some(e=>e.slots.some(e=>void 0===e.stop));e&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map((e,t,i)=>{if(void 0!==e.stop)return e;const s=i[t+1];return Object.assign(Object.assign({},e),{stop:s?s.start:"00:00:00"})})}))}))}return}if(t==pe.Single&&!i){if(me([...this.schedule.entries],[...We.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Be.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Ze)})})});this.schedule=qe(e,this.hass)}return void(this.viewMode=t)}new Promise(t=>{const i={title:Bi("ui.dialog.confirm_migrate.title",this.hass),description:Bi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};Ds(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then(function(){return no}),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Ie(ze(Ae(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))}),e})(this.schedule),this.viewMode=t)})}};ro.styles=ga,a([t.property({attribute:!1})],ro.prototype,"hass",void 0),a([t.state()],ro.prototype,"_params",void 0),a([t.property({type:Boolean,reflect:!0})],ro.prototype,"large",void 0),a([t.state()],ro.prototype,"schedule",void 0),a([t.state()],ro.prototype,"selectedEntry",void 0),a([t.state()],ro.prototype,"selectedSlot",void 0),a([t.state()],ro.prototype,"_panel",void 0),a([t.state()],ro.prototype,"_viewMode",void 0),ro=a([t.customElement("dialog-scheduler-editor")],ro);var lo=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return ro}}),co=window&&window.__assign||function(){return co=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e},co.apply(this,arguments)};var ho={second:45,minute:45,hour:22,day:5};const uo=(e,t,i)=>{if(i===De.am_pm||!i&&t.time_format===De.am_pm){const t=Le(e.getHours()).am_pm;return`${Le(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===De.twenty_four||!i&&t.time_format===De.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Me(t)}):Me(t)?uo(e,t,De.am_pm):uo(e,t,De.twenty_four)};let mo=class extends he{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Ya[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Bi("ui.components.date.next_week_day",this._hass,"{weekday}",$s(e,"long",this._hass)):1==s?a=Bi("ui.components.date.tomorrow",this._hass):s>0&&(a=$s(e,"long",this._hass));let o=Bi("ui.components.time.absolute",this._hass,"{time}",uo(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Bi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Bi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ts("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ts("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=co(co({},ho),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var h=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(h))>0)return{value:Math.round(h),unit:"month"};var u=a/604800;return{value:Math.round(u),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return Z``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),Z`
      ${es(this.relativeTime(this.datetime))}
    `}};a([Ws()],mo.prototype,"_hass",void 0),a([Ws()],mo.prototype,"datetime",void 0),mo=a([Hs("scheduler-relative-time")],mo);let po=class extends he{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return Z``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Oa(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Ki(r.service))&&(e=r.service),e&&(d=ia(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),Z`
      <ha-icon
        icon="${d}"
      ...
      >
        ${this.renderDisplayItem((null===(s=this.config.display_options)||void 0===s?void 0:s.primary_info)||Ve)}
        <div class="secondary">
        ${this.renderDisplayItem((null===(a=this.config.display_options)||void 0===a?void 0:a.secondary_info)||He)}
        </div>
      </div>
      <div class="state">
        ${!1!==this.config.show_toggle_switches?Z`<ha-switch
    ...
    `}catch(e){return Z`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return Z`
          ${t[0]?s.unsafeHTML(t[0]):""}
          <scheduler-relative-time
            .hass=${this.hass}
            .datetime=${new Date(e)}
          >
          </scheduler-relative-time>
          ${t[1]?s.unsafeHTML(t[1]):""}
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return Z`
          <div class="tags">
            ${null==t?void 0:t.map(e=>Z`<span class="tag">${e}</span>`)}
          </div>`}return s.unsafeHTML(e)};return Cs(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>Z`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){e.stopPropagation();const t=!e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return c`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};a([t.property()],po.prototype,"hass",void 0),a([t.property()],po.prototype,"schedule_id",void 0),a([t.property()],po.prototype,"schedule",void 0),a([t.property()],po.prototype,"config",void 0),po=a([t.customElement("scheduler-item-row")],po),e.SchedulerCard=class extends he{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}async setConfig(e){e=(e=>{let t=[];if(Ke(e,"include")&&!Xe(e.include)&&t.push("'include' must be a list of strings"),Ke(e,"exclude")&&!Xe(e.exclude)&&t.push("'exclude' must be a list of strings"),Ke(e,"discover_existing")&&!Ge(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ke(e,"title")||Ge(e.title)||Ye(e.title)||t.push("'title' must be a boolean or string"),Ke(e,"time_step")&&(!Je(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Ke(e,"show_header_toggle")&&!Ge(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ke(e,"show_add_button")&&!Ge(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ke(e,"show_toggle_switches")&&!Ge(e.show_toggle_switches)&&t.push("'show_toggle_switches' must be a boolean"),Ke(e,"display_options")&&(Qe(e.display_options)?(!Ke(e.display_options,"primary_info")||Ye(e.display_options.primary_info)||Xe(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ke(e.display_options,"secondary_info")||Ye(e.display_options.secondary_info)||Xe(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Ke(e.display_options,"icon")||Ye(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Ke(e,"sort_by")||Ye(e.sort_by)||Xe(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ke(e,"customize")&&!Qe(e.customize))t.push("'customize' must be a struct");else if(Ke(e,"customize")){let i=Object.entries(e.customize).map(([e,t])=>et(e,t)).filter(Ze);i.length&&t.push(...i)}if(!Ke(e,"tags")||Ye(e.tags)||Xe(e.tags)||t.push("'tags' must be a string or list of strings"),!Ke(e,"exclude_tags")||Ye(e.tags)||Xe(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e)}async firstUpdated(){await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-generic-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await Ms(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>Yi(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){const e=Object.keys(i).filter(e=>i[e]!==this._config[e]);e.some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ts("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ts("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>Qi(e,this._config)),i=e.filter(e=>!Qi(e,this._config));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return Z`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${!Ze(this._config.title)||"boolean"==typeof this._config.title&&this._config.title?Bi("ui.panel.common.title",this.hass):"boolean"==typeof this._config.title?"":this._config.title}
          </div>

          ${Object.keys(this.schedules||{}).length&&this._config.show_header_toggle?Z`
          <ha-switch
            ?checked=${s}
    ...
    ${this.connectionError?Z`
        <div>
          <hui-warning .hass=${this.hass}>
            <span style="white-space: normal">
              ${Bi("ui.panel.overview.backend_error",this.hass)}
            </span>
          </hui-warning>
        </div>
      `:Object.keys(e).length?t.map(e=>Z`
            <scheduler-item-row
              .hass=${this.hass}
              .config=${this._config}
          ...
          `):Z`
        <div>
          ${Bi("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}

      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?Z`
        ...
        ${!1!==this._config.show_add_button?Z`
    ...
    `}async loadSchedules(){Se(this.hass).then(e=>{this.schedules=Es(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>Qi(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Ts(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!Qi(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=Es(a,this._config,this.hass)):a=Es([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:qe(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};Ds(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return lo}),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==pe.Scheme?JSON.parse(JSON.stringify(We)):JSON.parse(JSON.stringify(Be));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};Ds(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then(function(){return lo}),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked,i=Object.values(this.schedules).filter(e=>this.showDiscovered||Qi(e,this._config));i.forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=c`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
  ...
  `,a([t.property({attribute:!1})],e.SchedulerCard.prototype,"hass",void 0),a([t.property()],e.SchedulerCard.prototype,"_config",void 0),a([t.state()],e.SchedulerCard.prototype,"schedules",void 0),a([t.state()],e.SchedulerCard.prototype,"showDiscovered",void 0),e.SchedulerCard=a([t.customElement("scheduler-card")],e.SchedulerCard),window.customCards=window.customCards||[],window.customCards.push({type:"scheduler-card",name:"Scheduler Card",description:"Card to manage schedule entities made with scheduler-component."}),console.info(`%c  SCHEDULER-CARD  \n%c  Version: ${"v4.0.16".padEnd(7," ")}`,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray")}({},decorators,styleMap,unsafeHtml);
